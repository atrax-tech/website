...
## Представление
Нематериальная информация содержится в структуре материальных объектов. Зарубки на дереве, электрический потенциал в элементах микросхемы — все это содержит информацию.
